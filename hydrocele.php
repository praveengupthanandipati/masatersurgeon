    ...
    <main>
        ...
        <section class="page-hero">
            <div class="container-90">
                <h1 class="page-hero-title">Hydrocele Treatment</h1>
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="about-media" data-aos="fade-right">
                            <div class="about-media-frame">
                                <img src="img/Hydrocele_treatment.jpg" alt="Hydrocele treatment at Master Surgeon" class="about-img">
                            </div>
        ...
        <section class="why-section">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Symptoms of Hydrocele</h2>
        ...
        <section class="why-section" style="padding-top: 0;">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    <span class="section-eyebrow">Understanding the Types</span>
                    <h2 class="section-title">Types of Hydrocele</h2>
        ...
        <section class="why-section" style="padding-top: 0;">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">How is a Hydrocele Treated?</h2>
        ...
        <section class="recovery-journey">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">How We Treat Hydrocele at Master Surgeon</h2>
