    ...
    <main>
        ...
        <section class="page-hero">
            <div class="container-90">
                <h1 class="page-hero-title">Stomach &amp; Intestine Cancers</h1>
                <div class="page-hero-breadcrumb">
                    <a href="index.php">Home</a>
                    <i class="fi fi-rs-angle-small-right"></i>
                    <span>Stomach &amp; Intestine Cancers</span>
                </div>
            </div>
        </section>
        <!--/ page hero -->
                    ...
                    <div class="col-12 col-lg-5">
                        <div class="about-media" data-aos="fade-right">
                            <div class="about-media-frame">
                                <img src="img/stomach_Intestine_cancers.jpg" alt="Stomach and intestine cancer surgery at Master Surgeon" class="about-img">
                            </div>
        ...
        <section class="why-section">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Warning Signs You Should Not Ignore</h2>
        ...
        <section class="why-section" style="padding-top: 0;">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Types of Stomach &amp; Intestine Cancers</h2>
        ...
        <section class="recovery-journey">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">How We Treat Stomach &amp; Intestine Cancers at Master Surgeon</h2>
