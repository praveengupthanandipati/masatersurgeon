    ...
    <main>
        ...
        <section class="page-hero">
            <div class="container-90">
                <h1 class="page-hero-title" data-aos="fade-down">Cholecystectomy &mdash; Open &amp; Laparoscopy</h1>
                <div class="page-hero-breadcrumb" data-aos="fade-up" data-aos-delay="150">
                    <a href="index.php">Home</a>
                    <i class="fi fi-rs-angle-small-right"></i>
                    <span>Cholecystectomy Open / Laparoscopy</span>
                </div>
            </div>
        </section>
        <!--/ page hero -->

        <!-- intro about cholecystectomy -->
                ...
                <div class="row align-items-center g-4 g-lg-5 about-row">
                    ...
                    <div class="col-12 col-lg-7">
                        <div class="about-content" data-aos="fade-left">
                            ...
                            <h2 class="about-title">What is <span>Cholecystectomy?</span></h2>
                            <p class="about-text">Cholecystectomy is the surgical removal of the gallbladder, a small organ under the liver that stores bile to help digest fats. It is the standard treatment for gallstones and gallbladder inflammation, which can cause severe pain, infection and other complications if left untreated.</p>
                            <p class="about-text">The operation can be done as <strong>laparoscopic (keyhole) surgery</strong> through a few tiny incisions, or as <strong>open surgery</strong> through one larger incision. Most patients are suitable for the keyhole approach, and your surgeon will recommend what is safest for you.</p>

                            <ul class="about-list">
                                <?php foreach ($data['cholecystectomy']['goals'] as $goal): ?>
        ...
        <section class="why-section">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Symptoms of Gallbladder Problems</h2>
                    <p class="section-subtitle">Gallstone pain often follows a heavy or fatty meal. Please see a surgeon if you have any of these, and urgently if you also have fever or jaundice.</p>
                </div>

                <div class="row g-4 row-cards justify-content-center">
                    <?php foreach ($data['cholecystectomy']['symptoms'] as $i => $symptom): ?>
        ...
        <section class="why-section" style="padding-top: 0;">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Open vs. Laparoscopic Cholecystectomy</h2>
                    <p class="section-subtitle">Both approaches are safe and effective. We choose the one that suits your condition best.</p>
                </div>

                <div class="row g-4 row-cards justify-content-center">
                    <?php foreach ($data['cholecystectomy']['types'] as $i => $type): ?>
        ...
        <section class="why-section" style="padding-top: 0;">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">When is Gallbladder Removal Needed?</h2>
                    <p class="section-subtitle">Surgery is recommended when the gallbladder causes repeated symptoms or puts your health at risk.</p>
                </div>

                <div class="row g-4 row-cards justify-content-center">
                    <?php foreach ($data['cholecystectomy']['options'] as $i => $option): ?>
        ...
        <section class="recovery-journey">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">How We Treat Gallbladder Disease at Master Surgeon</h2>
                ...
                <div class="row g-4 row-cards justify-content-center">
                    <?php foreach ($data['cholecystectomy']['steps'] as $step): ?>
                        <div class="col-12 col-sm-6 col-lg-4">
        ...
        <section class="faq-section">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    ...
                    <h2 class="section-title">Cholecystectomy &mdash; Frequently Asked Questions</h2>
                </div>

                <div class="row justify-content-center">
                    <div class="col-12 col-lg-10 col-xl-8">
                        <div class="faq-list">
                            <?php foreach ($data['cholecystectomy']['faqs'] as $faq): ?>
