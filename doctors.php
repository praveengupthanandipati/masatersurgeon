    ...
    <main>
        ...
        <section class="page-hero">
            <div class="container-90">
                <h1 class="page-hero-title">Our Doctors</h1>
        ...
        <section class="doctors-section">
            <div class="container-90">
                <div class="section-heading" data-aos="fade-up">
                    <span class="section-eyebrow">Meet Our Team</span>
                    <h2 class="section-title">Experienced Doctors You Can Trust</h2>
                    <p class="section-subtitle">Specialists dedicated to safe, precise and compassionate care at every stage of your treatment.</p>
                </div>
